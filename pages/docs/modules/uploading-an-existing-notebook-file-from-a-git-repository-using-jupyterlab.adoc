...
. In the JupyterLab interface click the *Git Clone* button (img:{site-baseurl}/assets/img/pages/docs/images/jupyterlab-git-clone-button.png[Git Clone button, width=30]).
+
