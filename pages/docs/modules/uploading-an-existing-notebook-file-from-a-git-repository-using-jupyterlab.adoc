...
. In the JupyterLab interface click the *Git Clone* button (image:{site-baseurl}/assets/img/pages/docs/images/jupyterlab-git-clone-button.png[Git Clone button,20,20]).
+
