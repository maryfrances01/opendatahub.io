...
. In the JupyterLab interface click the *Git Clone* button (image:jupyterlab-git-clone-button.png[Git Clone button]).
+
You can also click *Git* -> *Clone a repository* in the menu, or click the Git icon (image:{site-baseurl}/assets/img/pages/docs/jupyterlab-git-button.png[Git button]) and click the *Clone a repository* button.
+
