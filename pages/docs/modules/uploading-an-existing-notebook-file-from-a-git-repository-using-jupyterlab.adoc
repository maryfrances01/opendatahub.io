...
+
You can also click *Git* -> *Clone a repository* in the menu, or click the Git icon (image:jupyterlab-git-button.png[Git button]) and click the *Clone a repository* button.
+
