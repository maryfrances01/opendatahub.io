...
* The *Help* menu image:https://maryfrances01.github.io/opendatahub.io/assets/img/pages/docs/images/rhods-help-icon.png["Help menu icon"] provides a link to create a ticket with Red Hat Support and access the OpenShift Data Science documentation.
