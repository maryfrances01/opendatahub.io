...
* The *Notifications* button (image:https://maryfrances01.github.io/opendatahub.io/assets/img/pages/docs/images/rhods-notifications-icon.png["Notifications icon"]) opens and closes the *Notifications* drawer, letting you read current and previous notifications in more detail.
* The *Help* menu (image:https://maryfrances01.github.io/opendatahub.io/assets/img/pages/docs/images/rhods-help-icon.png["Help menu icon", 35, 35]) provides a link to create a ticket with Red Hat Support and access the OpenShift Data Science documentation.
