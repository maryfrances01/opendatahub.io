...
image::https://opendatahub.io/assets/img/pages/docs/images/rhods-topnav.png[The global navigation bar]

* The side navigation menu, which contains different categories of pages available in OpenShift Data Science.
+
.The side navigation menu
image::https://opendatahub.io/assets/img/pages/docs/images/rhods-sidenav.png[The side navigation menu]
...
* The *Notifications* button (image:https://opendatahub.io/assets/img/pages/docs/images/rhods-notifications-icon.png["Notifications icon"]) opens and closes the *Notifications* drawer, letting you read current and previous notifications in more detail.
* The *Help* menu (image:https://opendatahub.io/assets/img/pages/docs/images/rhods-help-icon.png["Help menu icon"]) provides a link to create a ticket with Red Hat Support and access the OpenShift Data Science documentation.
