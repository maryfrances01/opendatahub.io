...
image::opendatahub.io/docs/opendatahub.io/assets/img/pages/docs/images/rhods-topnav.png[The global navigation bar]

* The side navigation menu, which contains different categories of pages available in OpenShift Data Science.
+
.The side navigation menu
image::opendatahub.io/docs/opendatahub.io/assets/img/pages/docs/images/rhods-sidenav.png[The side navigation menu]
...
image::opendatahub.io/docs/opendatahub.io/assets/img/pages/docs/images/rhods-main-area.png[The main display area]
